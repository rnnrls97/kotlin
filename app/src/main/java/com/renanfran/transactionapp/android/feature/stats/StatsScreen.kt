...
import com.renanfran.transactionapp.android.feature.home.TransactionList
...
fun StatsScreen(navController: NavController, viewModel: StatsViewModel = hiltViewModel()) {
    Scaffold(topBar = {
        ...
        Column(modifier = Modifier.padding(it)) {
            ...
            TransactionList(Modifier, list = topExpense.value, "Top Spending", onSeeAllClicked = {}, onItemClicked = {}, onItemLongPressed = {})
        }
    }
}
